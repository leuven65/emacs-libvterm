...
static int osc_callback(int cmd, VTermStringFragment frag, void *user) {
  ...
  static const VTermStringFragment invalid_VTermStringFragment = {.len = -1};
  static const size_t MAX_STRING_FRAGMENT_LEN = invalid_VTermStringFragment.len;
  if (frag.len < MAX_STRING_FRAGMENT_LEN) {
